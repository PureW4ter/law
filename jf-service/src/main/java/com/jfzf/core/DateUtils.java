...
public class DateUtils {
	...
	public static Date parseDate10(String string) {
		try {
			return (Date) DATE10_DF.parseObject(string);
	...
	public static Date parseDate8(String string) {
		try {
			return (Date) DATE8_DF.parseObject(string);
		} catch (ParseException e) {
			return null;
		}
	}
	...
	public static Date parseDatetime(String string) {
		try {
			return (Date) DATETIME_DF.parseObject(string);
		} catch (ParseException e) {
			return null;
		}
	}
	...
	public static Date parseTimestamp(String string) {
		try {
			return (Date) TIMESTAMP_DF.parseObject(string);
		} catch (ParseException e) {
			return null;
		}
	}
	...
	public static Date parseDatetimeISO(String string) {
		try {
			return (Date) DATETIME_ISO_DF.parseObject(string);
		} catch (ParseException e) {
			return null;
		}
	}
	...
	public static Date parse(String string, String pattern) {
		try {
			return (Date) FastDateFormat.getInstance(pattern).parseObject(string);
		} catch (ParseException e) {
			return null;
		}
	}
	...
	public static Date parse(String string) {
		...
		for (String format : ACCEPT_DATE_FORMATS) {
			try {
				return (Date) FastDateFormat.getInstance(format).parseObject(string);
			} catch (ParseException e) {
				continue;
			}
		}
